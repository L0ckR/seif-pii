...
def compare(dataset: Path, reference_cache: Path, candidate_cache: Path) -> dict:
    ...
    return {
        "schema_version": 1,
        "measured_at_utc": candidate["measured_at_utc"],
        ...
        "reference": cache_description(reference_cache),
        "candidate": cache_description(candidate_cache),
        ...
        "hybrid_changes": compare_cases(
            before,
            after,
            {
                "reference": baseline_predictions["hybrid"],
                "candidate": candidate_predictions["hybrid"],
            },
        ),
